...
Aegis.prototype.find=function(selector){return new Aegis(this.collection[0].querySelectorAll(selector))};Aegis.prototype.attribute=function(attribute,value){if(typeof value==="undefined")this.collection[0].getAttribute(attribute);else return this.collection[0].setAttribute(attribute,value)};function $_(selector){if(typeof selector!="undefined")return new Aegis(selector);else return Aegis}function $_ready(callback){window.addEventListener("load",callback)}
